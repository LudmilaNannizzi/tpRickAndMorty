...
//TERTNARIOS
//condicion ? lo que se ejecuta si la condicion es true : lo que se ejecuta si la condicion es false
const printData = (arr) => {
  let card = "";
  ...
  arr.forEach((personaje) => {
    card =
      ...
      `
      <div>
        <div class="card" data-id="${personaje.id}" onclick="mostrarDetalles(${
        personaje.id
      })>
...
const mostrarDetalles = () => {
  const characterId = document.currentTarget.getAttribute("data-id");
